    ...
    def test__cycle(self):
        with inotify.test_support.temp_path() as path:
            ...
            expected = [
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=256, cookie=0, len=16),
                    ["IN_CREATE"],
                    path1,
                    "seen_new_file2",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=32, cookie=0, len=16),
                    ["IN_OPEN"],
                    path1,
                    "seen_new_file2",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=8, cookie=0, len=16),
                    ["IN_CLOSE_WRITE"],
                    path1,
                    "seen_new_file2",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=256, cookie=0, len=16),
                    ["IN_CREATE"],
                    path2,
                    "seen_new_file3",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=32, cookie=0, len=16),
                    ["IN_OPEN"],
                    path2,
                    "seen_new_file3",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=8, cookie=0, len=16),
                    ["IN_CLOSE_WRITE"],
                    path2,
                    "seen_new_file3",
                ),
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=512, cookie=0, len=16),
                    ["IN_DELETE"],
                    path1,
                    "seen_new_file2",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=512, cookie=0, len=16),
                    ["IN_DELETE"],
                    path2,
                    "seen_new_file3",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=1024, cookie=0, len=0),
                    ["IN_DELETE_SELF"],
                    path1,
                    "",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=2, mask=32768, cookie=0, len=0),
                    ["IN_IGNORED"],
                    path1,
                    "",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=1, mask=1073742336, cookie=0, len=16
                    ),
                    ["IN_DELETE", "IN_ISDIR"],
                    path,
                    "aa",
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=1024, cookie=0, len=0),
                    ["IN_DELETE_SELF"],
                    path2,
                    "",
                ),
                (
                    inotify.adapters._INOTIFY_EVENT(wd=3, mask=32768, cookie=0, len=0),
                    ["IN_IGNORED"],
                    path2,
                    "",
                ),
    ...
    def test__renames(self):
        ...
        with inotify.test_support.temp_path() as path:
            ...
            expected = [
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=1, mask=1073742080, cookie=events1[0][0].cookie, len=16
                    ),
                    ["IN_CREATE", "IN_ISDIR"],
                    path,
                    "old_folder",
            ...
            expected = [
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=1, mask=1073741888, cookie=events2[0][0].cookie, len=16
                    ),
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=1, mask=1073741952, cookie=events2[1][0].cookie, len=16
                    ),
            ...
            expected = [
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=3, mask=64, cookie=events3[3][0].cookie, len=16
                    ),
                    ["IN_MOVED_FROM"],
                    new_path,
                    "old_filename",
                ...
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=3, mask=128, cookie=events3[4][0].cookie, len=16
                    ),
                    ["IN_MOVED_TO"],
                    new_path,
                    "new_filename",
    ...
    def test__automatic_new_watches_on_new_paths(self):
        ...
        with inotify.test_support.temp_path() as path:
            ...
            expected = [
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=1, mask=1073742080, cookie=0, len=16
                    ),
                    ["IN_CREATE", "IN_ISDIR"],
                    path,
                    "folder1",
            ...
            expected = [
                (
                    inotify.adapters._INOTIFY_EVENT(
                        wd=2, mask=1073742080, cookie=0, len=16
                    ),
                    ["IN_CREATE", "IN_ISDIR"],
                    path1,
                    "folder2",
